...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2025 at 08:33 PM
...
(12, '../uploads/admin_profiles/677acf269ea38-395229621_83d168a8-b5a0-4abb-b0d6-237b34018a1e.jpg', 'admin', 'admin@gmail.com', 'admin', 'MIS');
...
(13, 'sample', 'sample', '2025-01-05 19:20:56', 12);
...
(40, 60, 'A new student has registered: ghea (ghea@gmail.com)', 1, '2025-01-05 19:06:16');
...
(60, 'ghea', 'a', 'ababon', '2025-01-05 19:06:16', 0x3135353034353631315f3337383435343335393839333534335f353537303039373733353037373638323434305f6e2e6a7067, 0, 0, 0, NULL);
...
--
ALTER TABLE `announcements`
  ADD CONSTRAINT `announcements_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
